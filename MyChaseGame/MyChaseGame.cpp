...
void Prey::AutoMove(const Arena& a, int z) {
    ...
    case 1:
        ...
        break;
    case 2:
        if (location.x != a.width && location.y != 1) {
            location.x += 1;
            location.y -= 1;
        }
        else cout << "Выход за пределы" << endl;
    ...
    case 4:
        ...
        break;
    case 5:
        if (location.x != 1 && location.y != a.length) {
            location.x -= 1;
            location.y += 1;
        }
        else cout << "Выход за пределы" << endl;
        break;
    case 6:
        if (location.y != a.length) {
            location.y += 1;
        }
        else cout << "Выход за пределы" << endl;
        break;
    case 7:
        if (location.x != a.width && location.y != a.length) {
            location.x += 1;
            location.y += 1;
        }
        else cout << "Выход за пределы" << endl;
...
void Predator::AutoMove(const Arena& ar, int z) {
    ...
    case 0:
        ...
        break;
    case 1:
        if (location.x <= (ar.width - a)) {
            location.x += a;
        }
        else cout << "Выход за пределы" << endl;
        break;
    case 2:
        if (location.y <= (ar.length - a)) {
            location.y += a;
        }
        else cout << "Выход за пределы" << endl;
        break;
